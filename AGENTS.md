...
This repo contains the `frappe-ctl` CLI. If you're operating ERPNext via this tool, read `SKILL.md` for the full operator reference.
...
For operating ERPNext with this CLI → see `SKILL.md`.
