...
// output to an agent that can't parse it. Chctl-inspired (ROADMAP.md
// Functional bucket). Verified against the is-ai-agent Rust crate's actual
// source (what clickhousectl uses) rather than guessed —
// https://docs.rs/is-ai-agent/latest/src/is_ai_agent/lib.rs.html
...
// (chctl README: "any tool that sets the standard AGENT env var").
